                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="hidden lg:ml-4 lg:flex lg:items-center">
                            <button
                                className="flex-shrink-0 rounded-full border-2 border-transparent p-1 text-gray-400 transition duration-150 ease-in-out hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none"
                            ...
                            <div className="relative ml-4 flex-shrink-0">
                                ...
                                <div
                                    className="absolute right-0 mt-2 hidden w-48 origin-top-right rounded-md shadow-lg">
